...
RUN_NAME="${RUN_NAME:-colliderml_${DATASET}_det11_14_clustered_$(date +%Y%m%d_%H%M%S)}"
...
ETA_BIN_WIDTH="${ETA_BIN_WIDTH:-0.18}"
PHI_BIN_WIDTH="${PHI_BIN_WIDTH:-0.18}"
DEPTH_BIN_WIDTH="${DEPTH_BIN_WIDTH:-200}"
EDGE_DELTA_R="${EDGE_DELTA_R:-0.40}"
MIN_TRUTH_PURITY="${MIN_TRUTH_PURITY:-0.30}"
